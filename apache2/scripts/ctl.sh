...
HTTPD_PIDFILE=/Applications/wordpress-4.0-1/apache2/logs/httpd.pid


HTTPD="/Applications/wordpress-4.0-1/apache2/bin/httpd -f /Applications/wordpress-4.0-1/apache2/conf/httpd.conf"
...
. /Applications/wordpress-4.0-1/apache2/bin/envvars
