...
MYSQL_PIDFILE=/Applications/wordpress-4.0-1/mysql/data/mysqld.pid

MYSQL_START="/Applications/wordpress-4.0-1/mysql/bin/mysqld_safe --defaults-file=/Applications/wordpress-4.0-1/mysql/my.cnf --port=3306 --socket=/Applications/wordpress-4.0-1/mysql/tmp/mysql.sock  --datadir=/Applications/wordpress-4.0-1/mysql/data --log-error=/Applications/wordpress-4.0-1/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
