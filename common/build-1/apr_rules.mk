...
#
apr_builddir=/Applications/wordpress-4.0-1/common/build-1
apr_builders=/Applications/wordpress-4.0-1/common/build-1
top_builddir=/Applications/wordpress-4.0-1/common/build-1
...
#
CFLAGS=-I/Applications/wordpress-4.0-1/common/include -arch x86_64
CPPFLAGS=-I/Applications/wordpress-4.0-1/common/include -I/bitnami/mampstack-osx-x64/output/sqlite/include -I/Applications/wordpress-4.0-1/common/include/sasl -I/Applications/wordpress-4.0-1/common/include -arch x86_64
LDFLAGS=-L/bitnami/mampstack-osx-x64/output/sqlite/lib -L/Applications/wordpress-4.0-1/common/lib -arch x86_64
LIBS=
DEFS=-DHAVE_CONFIG_H
