...
WordPress is an open source, standards-compliant, fast, light and free
personal publishing platform. The project was started in 2003, with a set of
features designed to make the internet publishing experience easy. WordPress
blogs now reach a combined 70 million global visitors and 300 million
pageviews each month. 

You can learn more about WordPress at http://wordpress.org
...
versions of Apache, MySQL and PHP. WordPress Stack is distributed for free
...
To install Bitnami WordPress Stack you will need:
    ...
    - Compatible operantig systems:
      ...
      - A Windows operating system such as Windows 2000, XP, Vista, 7, 2008
...
bitnami-wordpress-4.0-1-linux-installer.run on Linux or
bitnami-wordpress-4.0-1-linux-x64-installer.run on Linux 64 bit or
bitnami-wordpress-4.0-1-windows-installer.exe on Windows or
bitnami-wordpress-4.0-1-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-wordpress-4.0-1-linux.run
...
'Installation Finished' page. You can choose to launch Bitnami WordPress
...
The rest of this guide assumes that you installed Bitnami WordPress
Stack in /home/user/wordpress-4.0-1 on Linux or C:\Program Files\Bitnami WordPress Stack
on Windows or /Applications/wordpress-4.0-1 on OS X and that you use port 8080 
...
/home/user/wordpress-4.0-1/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami WordPress Stack\apache2\logs\error.log on Windows or
/Applications/wordpress-4.0-1/apache2/logs/error.log.
...
http://wiki.bitnami.com/Components/Varnish 
...
http://wiki.bitnami.com/Applications/Bitnami_Wordpress/How_to_configure_WordPress_with_Varnish
